# This dockerfile uses extends image https://hub.docker.com/sinlov/go-make
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov/go-make
ARG GO_ENV_ROOT_BUILD_BIN_NAME=go-make
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/go-make/main.go
...
ENTRYPOINT [ "/app/go-make" ]
# CMD ["/app/go-make", "--help"]