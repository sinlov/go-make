	...
	jsonInfo = `
{
  ...
  "author": {
    ...
    "url": "https://github.com/sinlov/go-make"
  }
}
`
	jsonInfoGoStyle = `
{
  ...
  "homepage": "https://github.com/sinlov/go-make#readme"
}
`
)
...
func TestGetPackageJsonHomepage(t *testing.T) {
	...
	InitPkgJsonContent(jsonInfoGoStyle)
	assert.Equal(t, "https://github.com/sinlov/go-make#readme", GetPackageJsonHomepage())
}
